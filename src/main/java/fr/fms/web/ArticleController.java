...
public class ArticleController {
	...
	public String index(Model model, @RequestParam(name = "page", defaultValue = "0") int page,
		...
		if (idCat > 0) {
			articles = articleRepository.findByCategoryId(idCat, PageRequest.of(page, 5)); // affiche tous les articles
			// d'une catégorie à partir
			// de l'idCat
		} else {
		...
		// thymeleaf pourra delors vérifier si la page courante est égale à l'index de la page active
